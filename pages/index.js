      ...
      <Grid item lg={9}>
        <Grid container direction="column">
          ...
          <Typography variant="h5">
            ...
            cost, covid etc. Users must then be careful as they work on the
            internet especially with the upsurge of cybercriminals. <br />
            <br />
            We are conducting a short survey on how people take certain
            decisions during online activities. <br />
            The online survey should take you maximum [15 minutes]. You will at
            a certain point assume some roles e.g., secretary, sales
            representative, or an employee <br />
            <br />
